"""
Django settings for hustca project.
...
SECRET_KEY = '6bbstngqg8w!vjd8ez%(6zrk%i3aj!$*b$v4!rr99f+*w+h4ib'
...
WSGI_APPLICATION = 'hustca.wsgi.application'
